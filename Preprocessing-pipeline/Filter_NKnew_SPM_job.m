...
matlabbatch{1}.spm.meeg.preproc.filter.freq = [47 53];%[57 63];
...
matlabbatch{2}.spm.meeg.preproc.filter.freq = [97 103];%[117 123];
...
matlabbatch{3}.spm.meeg.preproc.filter.freq = [147 153];%[177 183];
