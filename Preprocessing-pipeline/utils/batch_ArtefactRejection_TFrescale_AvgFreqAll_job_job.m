%-----------------------------------------------------------------------
% Job saved on 12-Aug-2016 14:12:30 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6470)
...
matlabbatch{1}.spm.meeg.preproc.artefact.methods(1).channels{1}.all = 'all';
...
matlabbatch{4}.spm.meeg.tf.avgfreq.prefix = 'HFB';
matlabbatch{5}.spm.meeg.tf.avgfreq.D(1) = cfg_dep('Time-frequency rescale: Rescaled TF Datafile', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Dfname'));
matlabbatch{5}.spm.meeg.tf.avgfreq.freqwin = [1 3];
matlabbatch{5}.spm.meeg.tf.avgfreq.prefix = 'Delta';
matlabbatch{6}.spm.meeg.tf.avgfreq.D(1) = cfg_dep('Time-frequency rescale: Rescaled TF Datafile', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Dfname'));
matlabbatch{6}.spm.meeg.tf.avgfreq.freqwin = [4 7];
matlabbatch{6}.spm.meeg.tf.avgfreq.prefix = 'Theta';
matlabbatch{7}.spm.meeg.tf.avgfreq.D(1) = cfg_dep('Time-frequency rescale: Rescaled TF Datafile', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Dfname'));
matlabbatch{7}.spm.meeg.tf.avgfreq.freqwin = [8 12];
matlabbatch{7}.spm.meeg.tf.avgfreq.prefix = 'Alpha';
matlabbatch{8}.spm.meeg.tf.avgfreq.D(1) = cfg_dep('Time-frequency rescale: Rescaled TF Datafile', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Dfname'));
matlabbatch{8}.spm.meeg.tf.avgfreq.freqwin = [13 29];
matlabbatch{8}.spm.meeg.tf.avgfreq.prefix = 'Beta1';
matlabbatch{9}.spm.meeg.tf.avgfreq.D(1) = cfg_dep('Time-frequency rescale: Rescaled TF Datafile', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Dfname'));
matlabbatch{9}.spm.meeg.tf.avgfreq.freqwin = [30 39];
matlabbatch{9}.spm.meeg.tf.avgfreq.prefix = 'Beta2';
matlabbatch{10}.spm.meeg.tf.avgfreq.D(1) = cfg_dep('Time-frequency rescale: Rescaled TF Datafile', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Dfname'));
matlabbatch{10}.spm.meeg.tf.avgfreq.freqwin = [40 70];
matlabbatch{10}.spm.meeg.tf.avgfreq.prefix = 'Gamma';
