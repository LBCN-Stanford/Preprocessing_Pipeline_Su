function po = plot_browser_b(signal_all, sparam,labels,D,window,plot_cond, page, yl, bch,t,showlegend, cc, ax)
% if nargin < 11
%     showlegend = 1;
% end
% Nt = length(plot_cond);
...
%     set(ax,'linewidth',2,'fontsize',16,'ticklength',[0 0]);
...
for i = page
    ...
    ax.Title.String = ttl;
    set(ax,'linewidth',2,'fontsize',16,'ticklength',[0 0],'color',[0.98 0.98 0.98]);
